package captainapp.repository;

import captainapp.CaptainappApp;
import captainapp.config.Constants;
import captainapp.config.audit.AuditEventConverter;
import captainapp.domain.PersistentAuditEvent;
...
import static captainapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
