...
import captainapp.CaptainappApp;
import captainapp.domain.Authority;
import captainapp.domain.User;
import captainapp.repository.AuthorityRepository;
...
import captainapp.web.rest.errors.ExceptionTranslator;
import captainapp.web.rest.vm.KeyAndPasswordVM;
...
@SpringBootTest(classes = CaptainappApp.class)
